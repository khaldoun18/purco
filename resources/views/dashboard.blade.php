    ...
    <div class="container px-6 py-20 mx-auto ">
        ...
        <div class="grid grid-cols-3 medium:gap-[50px] max-small:grid-cols-2">
            ...
            <a  href="{{ route('profile') }}" wire:navigate>
                ...
                <div class="flex flex-col items-center justify-center py-6 leading-6 text-center bg-[#EEFFF1]">
                    <h1 class="mt-3 text-xl font-black max-small:text-sm">Vragen? Contacteer ons!</h1>
                    <h1 class="mt-1 text-xs large:mt-4">Nulla dolore eiusmod in amet aliqua</h1>
                    <h1 class="mt-1 text-xs ">reprehenderit nostrud sint nisi com</h1>
                    
                    <div class="large:flex large:gap-x-4 large:my-4">
                        <div class="flex large:gap-x-1">
