<x-app-layout>
    <div class="container mx-auto py-[80px]">
        <h1 class="mb-[60px] text-4xl font-black text-center max-small:text-2xl">Dashboard</h1>
        <div class="grid grid-cols-3 medium:gap-[50px] max-small:grid-cols-2">
            <a class="hover:bg-green-500" href="{{ route('quote') }}" wire:navigate>
                <div class="flex flex-col items-center justify-center py-6 text-center">


                    <svg width="70" height="70" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M18.937 67.9375H7.4375C4.33095 67.9375 1.8125 65.419 1.8125 62.3125V7.1875C1.8125 4.08095 4.33095 1.5625 7.4375 1.5625H34.4375C35.9907 1.5625 37.397 2.19208 38.4149 3.21006L44.0399 8.83506C45.0578 9.85291 45.6875 11.2592 45.6875 12.8125V28.3064"
                    ...
                    <h1 class="mt-3 font-bold">Offerte aanvragen</h1>

                </div>
            </a>
            <a class="hover:bg-green-500" href="{{ route('order') }}" wire:navigate>
                <div class="flex flex-col items-center justify-center py-6 text-center">
                    ...
                    <h1 class="mt-3 font-bold">Bestel nu</h1>
                </div>
            </a>
            <a class="hover:bg-green-500" href="{{ route('my-orders') }}" wire:navigate>
                <div class="flex flex-col items-center justify-center py-6 text-center">
                    ...
                    <svg width="72" height="73" viewBox="0 0 72 73" fill="none"
                        ...
                        <g clip-path="url(#clip0_27_5839)">
                            ...
                            <g mask="url(#mask0_27_5839)">
                                <path d="M42.8906 21.1484H33.1875" stroke="#CC1819" stroke-width="3"
                                    stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                <mask id="mask1_27_5839" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0"
                    ...
                    <h1 class="mt-3 font-bold">Mijn bestellingen</h1>
                </div>
            </a>

            <a class="hover:bg-green-500" href="{{ route('info-center') }}" wire:navigate>
                <div class="flex flex-col items-center justify-center py-6 text-center">
                    ...
                    <h1 class="mt-3 font-bold">Info Center</h1>
                </div>
            </a>

            <a class="hover:bg-green-500" href="{{ route('profile') }}" wire:navigate>
                <div class="flex flex-col items-center justify-center py-6 text-center">

                    <svg width="72" height="73" viewBox="0 0 72 73" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_27_5876)">
                            <mask id="mask0_27_5876" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0"
                                y="0" width="72" height="73">
