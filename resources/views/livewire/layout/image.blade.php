...
<div class="container mx-auto mb-[72px]">
    ...
    <div class="relative mt-[48px] mb-[30px] flex flex-col sm:max-w-[1296px]  items-start gap-[10px]">
        ...
        <div
            ...
            <p class="text-xs font-medium leading-6 text-center text-gray-800 sm:text-base max-w-[211px]">
                Nulla dolore eiusmod in amet aliqua reprehenderit nostrud sint nisi com
            </p>
            <div class="flex justify-between gap-8 whitespace-nowrap">
