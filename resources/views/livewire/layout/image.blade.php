...
<div class="container px-4 py-12 mx-auto sm:px-6 lg:px-8">
    <div class="flex flex-wrap -mx-4 overflow-hidden">
        ...
        <div class="w-full px-4 my-4 overflow-hidden sm:w-full md:w-2/3 lg:w-2/3 xl:w-2/3">
            <!-- Image source should be dynamic -->
            <img src="{{ asset('images/Figure.png') }}" alt="Worker" class="h-auto max-w-full rounded-lg shadow-md"/>
        </div>

        <!-- Right side contact card (full width on small screens, 1/3 on medium screens and above) -->
        <div class="w-full px-4 my-4 overflow-hidden sm:w-full md:w-1/3 lg:w-1/3 xl:w-1/3">
            <div class="relative p-6 bg-white rounded-lg shadow-lg">
                <h2 class="mb-4 text-xl font-bold text-center md:text-left">Vragen? Contacteer ons!</h2>
                <p class="mb-4 text-sm md:text-base">Nulla dolore eiusmod in amet aliqua reprehenderit nostrud sint nisi com</p>
                ...
                <span class="text-sm md:text-base">+32 12345678</span>
                </div>
                ...
                <span class="text-sm md:text-base">email@email.com</span>
            </div>
        </div>
    </div>
</div>
