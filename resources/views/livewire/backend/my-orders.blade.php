                                    ...
                                    <th scope="col" class="px-4 py-3 cursor-pointer  border-r-2 border-y-2 border-[#DBDADE]"
                                        ...
                                        <div class="flex gap-x-3">
                                            ...
                                            <svg width="6" height="12" viewBox="0 0 6 12" fill="none"
                                                ...
                                                <path
                                                    d=" M5.75226 2.82444L3.58807 0.286608C3.26218 -0.0955365 2.73576
                                        -0.0955365 2.40987 0.286608L0.245676 2.82444C-0.280751 3.44175 0.0952682 4.5
                                        0.83895 4.5L5.16735 4.5C5.91103 4.5 6.27869 3.44175 5.75226 2.82444Z"
                                        fill="#313131" />
                                    <path
                                        ...
                                        <div class="flex gap-x-2">
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    stroke="#338734" stroke-width="1.5" stroke-linecap="round" />
                                            </svg>
                                            <h1>Voldaan</h1>
                                        </div>
                                    </td>
...
{{ $orders->links('vendor.livewire.custom') }}
</div>
