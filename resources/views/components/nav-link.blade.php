...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1  border-y-[2px] border-[#338734] text-[16px] font-medium leading-4 text-[#338734] focus:outline-none focus:border-[#338734] transition duration-150 ease-in-out'
